...
Nexova Solutions es una consultora de recursos humanos y selección de talento fundada en 2011, con sede principal en Chile y una oficina de expansión en Argentina. La empresa cuenta con 120 empleados y factura aproximadamente 8 millones de dólares anuales a través de tres líneas de negocio: headhunting para perfiles de mandos medios y directivos, outsourcing de equipos de soporte al cliente para empresas tecnológicas, y formación corporativa en habilidades blandas y liderazgo.
...
Documento interno — 4Geeks Academy · AI Engineering Track Uso exclusivo para la generación de proyectos del programa
